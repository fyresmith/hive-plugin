...
// ---------------------------------------------------------------------------
// Deterministic color from Discord ID
// ---------------------------------------------------------------------------
...
function resolveUserColor(discordId: string, preferredColor?: string | null): string {
  return normalizeCursorColor(preferredColor) ?? getUserColor(discordId);
}

function toCursorHighlight(color: string): string {
  return `${color}33`;
}
